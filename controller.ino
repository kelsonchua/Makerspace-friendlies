...
// Accessories
const int launcherPin = 21; // Servo
...
void handleShoot() {
  Serial.println("FIRE!");
  launcherServo.write(180); // Move Servo to Shoot
  delay(500);               // Wait for mechanism
  launcherServo.write(90);  // Reset Servo
...
void setup() {
  ...
  launcherServo.write(90); // Idle pos
